                ...
                for (i = 0, l = variables.length; i < l; ++i) {
                    ...
                    if (def) {
                        ...
                        if (type === "Parameter") {
                            ...
                            // LSC: use parserServices here
                            if (config.args === "after-used" && parserServices.isa(def.name.parent, "Function") && !isAfterLastUsedArg(variable)) {
                                continue;
                            }
                        } else {
